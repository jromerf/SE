------------------------------------------------------------------------------
-- lcd_pantalla.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
--
------------------------------------------------------------------------------
-- Filename:          lcd_pantalla.vhd
-- Version:           1.00.a
-- Description:       Top level design, instantiates library components and user logic.
-- Date:              Wed Feb 17 20:08:28 2021 (by Create and Import Peripheral Wizard)
...
use lcd_pantalla_v1_00_a.user_logic;
...
end entity lcd_pantalla;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of lcd_pantalla is
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity lcd_pantalla_v1_00_a.user_logic
    generic map
    (
