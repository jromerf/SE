...
void write_B_DIR(Xuint32 baseaddr,Xuint32 col,Xuint32 dir){
	BANNER_enviarcondireccion(baseaddr,col,0,0x1C,dir);
	BANNER_enviarcondireccion(baseaddr,col,1,0x12,dir);
	BANNER_enviarcondireccion(baseaddr,col,2,0x12,dir);
	BANNER_enviarcondireccion(baseaddr,col,3,0x1E,dir);
	BANNER_enviarcondireccion(baseaddr,col,4,0x11,dir);
	BANNER_enviarcondireccion(baseaddr,col,5,0x11,dir);
	BANNER_enviarcondireccion(baseaddr,col,6,0x1F,dir);
}
...
void write_C_DIR(Xuint32 baseaddr,Xuint32 col,Xuint32 dir){
	BANNER_enviarcondireccion(baseaddr,col,0,0x0E,dir);
	BANNER_enviarcondireccion(baseaddr,col,1,0x11,dir);
	BANNER_enviarcondireccion(baseaddr,col,2,0x10,dir);
	BANNER_enviarcondireccion(baseaddr,col,3,0x10,dir);
	BANNER_enviarcondireccion(baseaddr,col,4,0x10,dir);
	BANNER_enviarcondireccion(baseaddr,col,5,0x11,dir);
	BANNER_enviarcondireccion(baseaddr,col,6,0x0E,dir);
}
...
void write_D_DIR(Xuint32 baseaddr,Xuint32 col,Xuint32 dir){
	BANNER_enviarcondireccion(baseaddr,col,0,0x1E,dir);
	BANNER_enviarcondireccion(baseaddr,col,1,0x11,dir);
	BANNER_enviarcondireccion(baseaddr,col,2,0x11,dir);
	BANNER_enviarcondireccion(baseaddr,col,3,0x11,dir);
	BANNER_enviarcondireccion(baseaddr,col,4,0x11,dir);
	BANNER_enviarcondireccion(baseaddr,col,5,0x11,dir);
	BANNER_enviarcondireccion(baseaddr,col,6,0x1E,dir);
}
...
void write_1_DIR(Xuint32 baseaddr,Xuint32 col,Xuint32 dir){
	BANNER_enviarcondireccion(baseaddr,col,0,0x04,dir);
	BANNER_enviarcondireccion(baseaddr,col,1,0x0C,dir);
	BANNER_enviarcondireccion(baseaddr,col,2,0x04,dir);
	BANNER_enviarcondireccion(baseaddr,col,3,0x04,dir);
	BANNER_enviarcondireccion(baseaddr,col,4,0x04,dir);
	BANNER_enviarcondireccion(baseaddr,col,5,0x04,dir);
	BANNER_enviarcondireccion(baseaddr,col,6,0x0E,dir);
}
...
void write_2_DIR(Xuint32 baseaddr,Xuint32 col,Xuint32 dir){
	BANNER_enviarcondireccion(baseaddr,col,0,0x0E,dir);
	BANNER_enviarcondireccion(baseaddr,col,1,0x11,dir);
	BANNER_enviarcondireccion(baseaddr,col,2,0x01,dir);
	BANNER_enviarcondireccion(baseaddr,col,3,0x02,dir);
	BANNER_enviarcondireccion(baseaddr,col,4,0x04,dir);
	BANNER_enviarcondireccion(baseaddr,col,5,0x08,dir);
	BANNER_enviarcondireccion(baseaddr,col,6,0x1F,dir);
}
...
void write_3_DIR(Xuint32 baseaddr,Xuint32 col,Xuint32 dir){
	BANNER_enviarcondireccion(baseaddr,col,0,0x0E,dir);
	BANNER_enviarcondireccion(baseaddr,col,1,0x11,dir);
	BANNER_enviarcondireccion(baseaddr,col,2,0x01,dir);
	BANNER_enviarcondireccion(baseaddr,col,3,0x0E,dir);
	BANNER_enviarcondireccion(baseaddr,col,4,0x01,dir);
	BANNER_enviarcondireccion(baseaddr,col,5,0x11,dir);
	BANNER_enviarcondireccion(baseaddr,col,6,0x0E,dir);
}
...
void write_4_DIR(Xuint32 baseaddr,Xuint32 col,Xuint32 dir){
	BANNER_enviarcondireccion(baseaddr,col,0,0x02,dir);
	BANNER_enviarcondireccion(baseaddr,col,1,0x06,dir);
	BANNER_enviarcondireccion(baseaddr,col,2,0x0A,dir);
	BANNER_enviarcondireccion(baseaddr,col,3,0x12,dir);
	BANNER_enviarcondireccion(baseaddr,col,4,0x1F,dir);
	BANNER_enviarcondireccion(baseaddr,col,5,0x02,dir);
	BANNER_enviarcondireccion(baseaddr,col,6,0x02,dir);
}
...
void write_diamante(Xuint32 baseaddr,Xuint32 col){
	BANNER_enviar(baseaddr,col,0,0x00);
	BANNER_enviar(baseaddr,col,1,0x00);
	BANNER_enviar(baseaddr,col,2,0x04);
	BANNER_enviar(baseaddr,col,3,0x0A);
	BANNER_enviar(baseaddr,col,4,0x04);
	BANNER_enviar(baseaddr,col,5,0x00);
	BANNER_enviar(baseaddr,col,6,0x00);
}

void write_diamante_DIR(Xuint32 baseaddr,Xuint32 col,Xuint32 dir){
	BANNER_enviarcondireccion(baseaddr,col,0,0x00,dir);
	BANNER_enviarcondireccion(baseaddr,col,1,0x00,dir);
	BANNER_enviarcondireccion(baseaddr,col,2,0x04,dir);
	BANNER_enviarcondireccion(baseaddr,col,3,0x0A,dir);
	BANNER_enviarcondireccion(baseaddr,col,4,0x04,dir);
	BANNER_enviarcondireccion(baseaddr,col,5,0x00,dir);
	BANNER_enviarcondireccion(baseaddr,col,6,0x00,dir);
}
