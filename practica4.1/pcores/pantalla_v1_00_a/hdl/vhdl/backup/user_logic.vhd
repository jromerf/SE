...
--Datos para saber que casilla voy a mover con los botones 
	casilla_a_mover(0) <= WFIFO2IP_Data(24);
	casilla_a_mover(1) <= WFIFO2IP_Data(23);
	casilla_a_mover(2) <= WFIFO2IP_Data(22);
	casilla_a_mover(3) <= WFIFO2IP_Data(21);
	casilla_a_mover(4) <= WFIFO2IP_Data(20);
	casilla_a_mover(5) <= WFIFO2IP_Data(19);
	casilla_a_mover(6) <= WFIFO2IP_Data(18);
	...
	vga: vgacore
		...
		(
			...
			casilla_a_mover=>casilla_a_mover,
			button => button,
			vsyncb => vsyncb,
			rgb => rgb
		);
